        ...
        if (this.data.data.traittype === 'call-on') {
            ...
            if (this.data.data.hasAptitudeModifier) {
                extraData.push({
                    ...
                    text: `${this.data.data.aptitudeTarget.trim()} : ${
                        this.data.data.aptitudeModifier
                    }`,
                });
            }
            if (this.data.data.hasDieModifier) {
                extraData.push({
                    title: 'Adds Dice',
                    text: `${this.data.data.dieModifierTarget} : ${
                        this.data.data.dieModifier >= 0
                            ? '+' + this.data.data.dieModifier
                            : this.data.data.dieModifier
                    }D`,
                });
            }
            if (this.data.data.hasObModifier) {
                extraData.push({
                    ...
                    text: `${this.data.data.obModifierTarget} : ${
                        this.data.data.obModifier >= 0
                            ? '+' + this.data.data.obModifier
                            : this.data.data.obModifier
                    } Ob`,
                });
            }
            ...
            if (this.data.data.addsReputation) {
                extraData.push({
                    ...
                    text: `${this.data.data.reputationDice}D ${
                        this.data.data.reputationInfamous ? 'infamous ' : ''
                    }reputation as ${this.data.data.reputationName}`,
                });
            }
        }
        extraData.push({
