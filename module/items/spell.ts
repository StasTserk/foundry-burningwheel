...
export class Spell extends BWItem<SpellData> {
    ...
    prepareData(): void {
        ...
        if (this.hasOwner && actor) {
            this.system.aptitude =
                10 - actor.system.perception.exp ||
                1 +
