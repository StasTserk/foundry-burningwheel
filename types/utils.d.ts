...
declare namespace foundry {
  const utils: {
     ...
     */
    getParentClasses(cls: ConstructorOf<any>): Array<ConstructorOf<any>>;
     ...
     */
    duplicate<T>(original: T): Duplicated<T>;
     ...
     */
    flattenObject(obj: object, _d?: number): any;
     ...
     */
    expandObject(obj: object, _d?: number): any;
     ...
     */
    invertObject(obj: object): object;
     ...
     */
    // eslint-disable-next-line @typescript-eslint/ban-types
    debounce(callback: (this: Function, ...args: any[]) => void, delay: number): (...args: any[]) => void;
     ...
     */
    hexToRGBAString(hex: number, alpha?: number): string;
     ...
     */
    colorStringToHex(color: string): number;
    ...
    // eslint-disable-next-line @typescript-eslint/ban-types
    benchmark(func: Function, iterations: number): void;
     ...
     */
    fromUuid(uuid: string): Promise<Entity | object | null>;
