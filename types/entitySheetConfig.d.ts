...
> extends FormApplication<P, EntitySheetConfig.Data, E> {
  ...
  protected static _getEntityTypes(entityClass: ConstructorOf<FoundryDocument>): string[];
...
declare namespace EntitySheetConfig {
   ...
   */
  interface Data<E extends FoundryDocument = FoundryDocument, P extends FormApplication.Options = FormApplication.Options> {
