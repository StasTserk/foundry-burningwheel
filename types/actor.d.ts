...
> extends FoundryDocument<D, PD> {
     ...
     */
    protected _prepareOwnedItems(
        items: Array<Actor.OwnedItemData<D>>
    ): Collection<I>;
 ...
 /* -------------------------------------------- */
    ...
    createOwnedItem(
        itemData: DeepPartial<Item.Data>[],
        options?: any
    ): Promise<Item.Data[]>;
    ...
    deleteEmbeddedDocuments(
        ...
        ids: string[],
        context?: FoundryDocument.ModificationContext
     ...
     * @returns An array of deleted document instances
     */
    createEmbeddedDocuments<T>(
        embeddedName: FoundryDocument.Types,
        data: Partial<FoundryDocument.Data<T>>[],
        context?: FoundryDocument.ModificationContext
    ): Promise<FoundryDocument[]>;
...
declare namespace Actor {
     ...
     */
    interface Data<D = any, I extends Item = Item>
        extends FoundryDocument.Data {
        /** Deprecated */
        data: D;
        system: D;
        effects: ActiveEffect.Data[];
