...
export async function handleNpcSpellRoll({
    ...
    dataPreset.useCustomDifficulty =
        dataPreset.showObstacles =
        dataPreset.showDifficulty =
            true;
                ...
                buttons: {
                    ...
                    root2: {
                        ...
                        callback: () => {
                            ...
                            rollData.statName = game.i18n.localize(
                                'BW.' + skill.system.root2
                            );
                            rollData.accessor = skill.system
