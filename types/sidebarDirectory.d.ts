...
> extends SidebarTab<P> {
    ...
    render(
        force?: boolean,
        context?: Partial<SidebarDirectory.RenderContext>
    ): this | void;
    ...
    ): SidebarDirectory.Data | PlaylistDirectory.Data;
    ...
    protected _onDragHighlight(
        event: JQuery.DragEnterEvent | JQuery.DragLeaveEvent
    ): void;
