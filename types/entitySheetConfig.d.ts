...
> extends FormApplication<P, EntitySheetConfig.Data, E> {
    ...
    protected _updateObject(
        event: Event,
        formData: EntitySheetConfig.FormData
    ): Promise<void>;
    ...
    static registerSheet(
        entityClass: ConstructorOf<FoundryDocument>,
        scope: string,
     ...
     */
    protected static _getEntityTypes<T extends string[]>(
        entityClass: any,
        types: T
    ): T;
    protected static _getEntityTypes(
        entityClass: ConstructorOf<FoundryDocument>
    ): string[];
     ...
     */
    protected static _updateDefaultSheets(
        setting?: Record<'Actor' | 'Item', Record<string, string>>
    ): void;
...
declare namespace EntitySheetConfig {
    interface Config {
        ...
        /** @deprecated */
        entityClass: ConstructorOf<FoundryDocument>;
        documentClass: ConstructorOf<FoundryDocument>;
        id: string;
        label: string;
        sheetClass: ConstructorOf<FormApplication>;
        types: string[];
     ...
     */
    interface Data<
        E extends FoundryDocument = FoundryDocument,
        P extends FormApplication.Options = FormApplication.Options
    > {
