...
> extends SidebarTab<P> {
  ...
  */
 static setupFolders(folders: Folder[], entities: FoundryDocument[]): SidebarDirectory.Tree;
  ...
  */
 protected _onCreateEntity(event: JQuery.ClickEvent): Promise<FoundryDocument>;
