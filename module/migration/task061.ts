...
function updateSkill(item: Skill): Record<string, number> {
    ...
    updateToNumber(
        item.data.data.learningProgress,
...
function updateTrait(item: Trait): Record<string, number> {
    const data = {};
    updateToNumber(
        item.data.data.affiliationDice,
        'data.affiliationDice',
        data
    );
    ...
    updateToNumber(
        item.data.data.aptitudeModifier,
        'data.aptitudeModifier',
        data
    );
    return data;
}
...
function updateSpell(item: Spell): Record<string, number> {
    const data = {};
    updateToNumber(
        item.data.data.willDamageBonus,
        'data.willDamageBonus',
        data
    );
    updateToNumber(
        item.data.data.learningProgress,
