        ...
        data.statRow = [
            {
                ...
                rollable,
                label: 'Wi',
                value: actor.data.data.will.exp,
                valuePath: 'will.exp',
                shade: actor.data.data.will.shade,
            ...
            },
            {
                ...
                rollable,
                label: 'Pe',
                value: actor.data.data.perception.exp,
                valuePath: 'perception.exp',
                shade: actor.data.data.perception.shade,
                shadePath: 'perception.shade',
                draggable: true,
                accessor: 'data.perception',
            },
            {
                statName: 'agility',
                rollable,
                label: 'Ag',
                value: actor.data.data.agility.exp,
                valuePath: 'agility.exp',
                shade: actor.data.data.agility.shade,
                shadePath: 'agility.shade',
                draggable: true,
                accessor: 'data.agility',
            },
            {
                statName: 'speed',
                rollable,
                label: 'Sp',
                value: actor.data.data.speed.exp,
                valuePath: 'speed.exp',
                shade: actor.data.data.speed.shade,
            ...
            },
            {
                ...
                rollable,
                label: 'Po',
                value: actor.data.data.power.exp,
                valuePath: 'power.exp',
                shade: actor.data.data.power.shade,
            ...
            },
            {
                ...
                rollable,
                label: 'Fo',
                value: actor.data.data.forte.exp,
                valuePath: 'forte.exp',
                shade: actor.data.data.forte.shade,
            ...
            },
            {
                ...
                rollable,
                label: 'Hea',
                value: actor.data.data.health.exp,
                valuePath: 'health.exp',
                shade: actor.data.data.health.shade,
                shadePath: 'health.shade',
                draggable: true,
                accessor: 'data.health',
            },
            {
                label: 'Ref',
                value: actor.data.data.reflexes || 0,
                valuePath: 'reflexes',
                shade: actor.data.data.reflexesShade,
                shadePath: 'reflexesShade',
            },
            {
                label: 'MW',
                value: actor.data.data.ptgs.moThresh || 0,
                valuePath: 'ptgs.moThresh',
                shade: actor.data.data.ptgs.woundShade,
            ...
            },
            {
                ...
                open,
                label: 'Ste',
                value: actor.data.data.steel.exp,
                valuePath: 'steel.exp',
                shade: actor.data.data.steel.shade,
            ...
            {
                label: 'Hes',
                value: actor.data.data.hesitation || 0,
            ...
            },
            {
                ...
                rollable,
                label: 'Res',
                value: actor.data.data.resources.exp,
                valuePath: 'resources.exp',
                shade: actor.data.data.resources.shade,
                shadePath: 'resources.shade',
                draggable: true,
                accessor: 'data.resources',
            },
            {
                statName: 'circles',
                rollable,
                label: 'Cir',
                value: actor.data.data.circles.exp,
                valuePath: 'circles.exp',
                shade: actor.data.data.circles.shade,
                shadePath: 'circles.shade',
                draggable: true,
                accessor: 'data.circles',
            },
            {
                label: 'Str',
                value: actor.data.data.stride,
                valuePath: 'stride',
            },
        ];
        ...
        actor.items.forEach((item: BWItem) => {
            ...
            switch (i.type) {
                case 'belief':
                    ...
                    break;
                case 'trait':
                    data.traits.push(i as TraitDataRoot);
                    break;
                case 'instinct':
