        ...
        if (this.system.traittype === 'call-on') {
            ...
            if (this.system.hasAptitudeModifier) {
                extraData.push({
                    ...
                    text: `${this.system.aptitudeTarget.trim()} : ${
                        this.system.aptitudeModifier
                    }`,
                });
            }
            if (this.system.hasDieModifier) {
                extraData.push({
                    title: 'Adds Dice',
                    text: `${this.system.dieModifierTarget} : ${
                        this.system.dieModifier >= 0
                            ? '+' + this.system.dieModifier
                            : this.system.dieModifier
                    }D`,
                });
            }
            if (this.system.hasObModifier) {
                extraData.push({
                    ...
                    text: `${this.system.obModifierTarget} : ${
                        this.system.obModifier >= 0
                            ? '+' + this.system.obModifier
                            : this.system.obModifier
                    } Ob`,
                });
            }
            ...
            if (this.system.addsReputation) {
                extraData.push({
                    ...
                    text: `${this.system.reputationDice}D ${
                        this.system.reputationInfamous ? 'infamous ' : ''
                    }reputation as ${this.system.reputationName}`,
                });
            }
        }
        extraData.push({
